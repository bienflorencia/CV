...
\begin{entrylist}
	...
	\entry
		...
		{Universidad de la Rep\'{u}blica, Uruguay}
		{Department of Biodiversity and Genetics, Clemente Estable Biological Research Institute. Advisor: \href{https://scholar.google.com/citations?user=uWh1ONQAAAAJ&hl=es}{Mariana Cosse}}
\end{entrylist}
...
\begin{description}
\item[]{\bf Enzo Cavalli}, BSc (Honours) in Biological Sciences, School of Science, {\bf Universidad de la Rep\'{u}blica}. Project: 'Effects of livestock on the mammal community of Paso Centurión, Cerro Largo'. Advisor, finished in 2019.
\item[]{\bf Rodrigo Montiel}, BSc (Honours) in Biological Sciences, School of Science, {\bf Universidad de la Rep\'{u}blica}. Project: 'Biodiversity informatics and community science in Uruguay'. Advisor, ongoing.
\end{description}
...
\begin{entrylist}
	\entry
		...
		{Lecture in the graduate course of Palaeontology, for 15-20 students. Invited by Dr. Richard Fari\~{n}a. [\href{https://flograttarola.com/pdf/mamiferos_julana.pdf}{link to slides}]}
	\entry
		{2018}
		{Management and analysis of camera trap records using R}
		{Ministry of Environment (Uruguay)}
		{Course for NGOs, researchers and government people. Taught together with Juan M. Barreneche and Gabriel Perazza. [\href{https://github.com/bienflorencia/curso_camtrapR}{link to syllabus}]}
	\entry
		{2016 -- 2017\\\footnotesize{two editions}}
		{Introduction to Python}
		{Universidad de la Rep\'{u}blica, Uruguay}
		{Lecture at posgraduate course 'Introduction to command line and programming for bioinformatic analysis', for 25-30 students in Biological Sciences. Invited by Dr. Andr\'{i}s Iriarte. [\href{https://github.com/bienflorencia/clases_python}{link to syllabus}]}
	\entry
	...
	\entry
		{2014}
		{Conservation biology, environmental education and community involvement}
		{Universidad de la Rep\'{u}blica, Uruguay}
...
\begin{minipage}[t]{0.35\textwidth}
	...
	\textbf{Google Scholar} (04/2022)\\
	75 citations, h-index = 5\\
\end{minipage} 
\hfill
...
\begin{entrylist}
	\entrylong
		...
		{Online}
		{\underline{Grattarola F.}* \& Barreneche J.M. \slashsep LatinR Conference}
	\entrylong
		{2021}
		{Roundtable: Activism through digital media}
		{Montevideo, Uruguay}
		{\underline{Grattarola F.}* \slashsep 4th Conference on Digital Citizenship}
	\entrylong
		{2021}
	...
	\entrylong
		...
		{\underline{Grattarola F.}* \& D. Pincheira-Donoso \slashsep British Ecological Society Annual Meeting}
	\entrylong
		{2019}
		{Biodiversidata: a collaborative initiative towards open data availability in Uruguay}
		{Leiden, The Netherlands}
		{\underline{Grattarola F.}* \& D. Pincheira-Donoso \slashsep Biodiversity Next Conference}
	\entrylong
	...
	\entrylong
		...
		{\underline{Grattarola F.}* \slashsep Rufford Conference Uruguay}
	\entrylong
		{2017}
...
\begin{entrylist}
	...
	\entrylong
		...
		{}
		{Online talk with primary school students from rural school N102 of Berachi (Cerro Largo, Uruguay)}
	\entrylong
		{2020}
	...
	\entrylong
		...
		{}
		{Talk at Museum of Natural History Torres de la Llosa}
	\entrylong
		{2019}
	...
	\entrylong
		...
		{}
		{Art exhibition about pioneer women in Computer Science at CSSconf and JSConf (Berlin, Germany)}
	\entrylong
		{2018}
