...
\end{minipage}
\begin{minipage}[t]{0.27\textwidth} % 27.5% of the page width for the first row of icons
	\vspace{-\baselineskip} % Required for vertically aligning minipages
...
\begin{minipage}[t]{0.3\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Bluesky}{12}{\href{https://bsky.app/profile/flograttarola.bsky.social}{@flograttarola.bsky.social}}\\
	\icon{Mastodon}{12}{\href{https://ecoevo.social/@flograttarola}{ecoevo.social/@flograttarola}}\\
...
I am a Uruguayan biologist (PhD) doing research in macroecology, biodiversity informatics, open science, and community science. I currently work as a postdoc researcher at the Czech University of Life Sciences (\href{https://petrkeil.github.io/}{\underline{MOBI Lab}}) in Czech Republic, focused on studying the temporal change of biodiversity. I am the founder of \href{https://biodiversidata.org/}{\underline{Biodiversidata}} (Uruguayan Consortium of Biodiversity Data), a member of the NGO \href{https://julana.org/}{\underline{JULANA}}, and the admin of \href{https://www.naturalista.uy/}{\underline{NaturalistaUY}} (the site of iNaturalist in Uruguay). I am a also a \href{https://explorers.nationalgeographic.org/directory/florencia-grattarola}{\underline{NatGeoExplorer}} and the co-chair of the RDA Sharing Rewards and Credit Interest Group (\href{https://www.rd-alliance.org/groups/sharing-rewards-and-credit-sharc-ig}{\underline{SHARC}}). I am a GBIF \href{https://www.gbif.org/article/1ye7qAa9Z2HVSn85bfSmLP/who-are-the-gbif-biodiversity-open-data-ambassadors}{\underline{Open Data Ambassador}} and I am also a \href{https://carpentries.org}{\underline{The Carpentries}} Instructor. \\\
...
%		{\lorem\lorem\\ \texttt{PHP}\slashsep\texttt{JS}\slashsep\texttt{MariaDB}\slashsep\texttt{Linux}}
	\entry
		...
		{Project 'BEAST: Biodiversity dynamics across a continuum of space, time, and their scales. MOBI Lab, European Union ERC Grant (PI Petr Keil). Working on analysing large data at a global scale to investigate the temporal change of biodiversity across scales. Comparing trends and patterns, integrating different data sources (e.g., local, gridded, checklists, messy data). Teaching in the postgraduate course: Spatial Ecology and Macroecology. Overseeing and designing a multi-taxa global database of regional red lists (RegRed) to assess species gains and losses at the national level.}
	\entry
		{05/2023 -- 08/2023}
		{Consultant}
		{Agencia Nacional de Investigación e Innovación (Uruguay)}
		{Programme 'Open Research Data Incentive'. Providing advice on the development of the Data Management Plan (DMP) model proposed for the new pilot Clemente Stable Fund of ANII (National Research Agency). Generating a support document for applicants to generate their DMP. Developing a virtual consultation for applicants to the fund. Generating a guidance document for evaluators of the different Technical Area Committees (TAC). Developing virtual training sessions for the eight TACs. Preparing reports including a detailed description of the tasks performed, documents and presentations prepared, and a series of recommendations for future steps in the Programme.}
	\entry
		{04/2021 -- 10/2023}
		{Postdoc}
		{Czech University of Life Sciences Prague (Czech Republic)}
		{Project 'Range dynamics of Neotropical carnivores'. MOBI Lab, REES ČZU Funding. Working on my own project about biodiversity data integration and species distribution models, analysing large data to study the spatial and temporal patterns of biodiversity in the Neotropical region with mammalian carnivores. Developing a database of camera trap and observation records (monitoring data) from carnivores (MIAU). Studying the biases associated with contributory citizen science data collection. Reporting a case study of the creation of iNaturalist Uruguay.}
	\entry
		{01/2021 -- 04/2021}
		{Intern}
		{UN Environmental Programme - World Conservation Monitoring Centre (Cambridge, UK)}
		{Knowledge Management internship in the Conserving Land and Seascapes Team. Contributing towards the development of the new Knowledge Portal of UNEP-WCMC.}
	\entry
		{08/2018 -- 12/2020\\\footnotesize{part time}}
		{Demonstrator}
		{University of Lincoln (Lincoln, United Kingdom)}
		{School of Life Sciences. Demonstrator of practical sessions in the courses of Zoology, Palaeontology, and Biological Anthropology}
	\entry
		{11/2017 -- 11/2020}
		{PhD student}
		{University of Lincoln (Lincoln, United Kingdom)}
		{Graduated with a PhD in Life Sciences with funding from the National Agency of Research and Innovation of Uruguay (ANII).}
	\entry
		{01/2017 -- 07/2017\\\footnotesize{part time}}
		{Project Manager}
		{Vida Silvestre NGO (Montevideo, Uruguay)}
		{Project ’Conservation in private protected areas of Uruguay’. Working in coordination with the forestry company UPM Uruguay and their system of protected areas.}
	\entry
		{11/2016 -- 03/2017}
		{Research Assistant}
		{Universidad de la Rep\'{u}blica (Montevideo, Uruguay)}
		{Bioinformatics and genomics at the Department of Animal Genetics, School of Veterinary. Researcher in bioinformatics analysing cattle samples for animal improvement.}
	\entry
		{10/2016 -- 11/2016}
		{Field Assistant}
	...
	\entry
		...
		{Research and teaching at the Department of Biodiversity and Genetics. Graduated with a BSc (Hons) and MSc in Biology.}
	\entry
		{05/2012 -- 04/2014\\\footnotesize{part time}}
		{Teaching Assistant}
		{Universidad de la Rep\'{u}blica (Montevideo, Uruguay)}
		{Coordinating with members of the School of Science and the local community of Malvin Norte.}
\end{entrylist}
...
\item Bonifacino, J. M., Mailhos, A., Marchesi, E., Rossado, A., Haretche, F., González Rosales, A., Brussa, C., Mai Morente, P., Speroni, G., Valtierra, V., Toranza, C., Pañella, P., Lezama, F., Cosse, M., \underline{Grattarola F.}, Preliasco, M., Berazategui, P., Beyhaut, R., Zabaleta, M., … \& Uy-BOL. (2026) Uruguay's Online Flora: A new resource connecting science, society, and conservation. \textit{\textbf{TAXON}}. [\href{https://doi.org/10.1002/tax.70085}{doi}]

\item Kadlec I., Uličný A., Keil P., \& \underline{Grattarola F.} (2025) Towards a new global database of regional red lists (RegRed): metadata. \textit{\textbf{Nature Conservation}}. [\href{https://doi.org/10.3897/natureconservation.60.158981}{doi}]

\item \underline{Grattarola F.}, Bergós L., Carabio M., Montiel R., \& González S. (2025) NaturalistaUY in Uruguay: a case of community science in Latin America from a critical perspective. \textit{\textbf{Desenvolvimento e Meio Ambiente}}. [\href{https://doi.org/10.5380/dma.v66i.95896}{doi}]

\item Mason B.M., Mesaglio T., Heitmann J.B., Chandler M., Chowdhury S., Gorta S, \underline{Grattarola F.}, Groom Q., Hitchcock C., Hoskins L., Lowe S.K., Marquis M., Pernat N., Shirey V., Baasanmunkh S., \& Callaghan C.T. (2025) iNaturalist accelerates biodiversity research. \textit{\textbf{BioScience}}. [\href{https://doi.org/10.1093/biosci/biaf104}{doi}]

\item Mabile L., Shmagun H., Erdmann C., Cambon-Thomsen A., Thomsen M., \& \underline{Grattarola F.} (2025) Recommendations on Open Science Rewards and Incentives: Guidance for Multiple Stakeholders in Research. \textit{\textbf{Data Science Journal}}. [\href{https://doi.org/10.5334/dsj-2025-015}{doi}]

\item \underline{Grattarola F.}, Tschernosterová K., \& Keil P. (2025) MIAU: An analysis-ready dataset on presence-only and presence-absence data of Neotropical carnivores (Mammalia, Carnivora) from 2000 to 2021. \textit{\textbf{Nature Conservation}}. [\href{https://doi.org/10.3897/natureconservation.58.140644}{doi}]

\item \underline{Grattarola F.}, Shmagun H., Erdmann C., Cambon-Thomsen A., Thomsen M., Jaesoo Kim J., \& Mabile L. (2024) Gaps between Open Science activities and actual recognition systems: Insights from an international survey. \textit{\textbf{PLOS One}}. [\href{https://doi.org/10.1371/journal.pone.0315632}{doi}]

\item \underline{Grattarola F.}, Tschernosterová K., \& Keil P. (2024) A continental-wide decline of occupancy and diversity in five Neotropical carnivores. \textit{\textbf{Global Ecology and Conservation}}. [\href{https://doi.org/10.1016/j.gecco.2024.e03226}{doi}]

\item \underline{Grattarola F.}, Laufer G., Rodríguez-Tricot L., González E., \& Teixeira de Mello F. (2024) Desafíos y barreras para la disponibilización de datos abiertos de biodiversidad en Uruguay. \textit{\textbf{Ecología Austral}}. [\href{https://doi.org/10.25260/EA.24.34.3.0.2413}{doi}]
...
\item Mellado-Mansilla D., Midolo G., Ortega-Solís G., Reif J., \underline{Grattarola F.}, Craven D., Leroy F., Perrone M., Stastny K., Bejcek V., \& Keil P. (2026) Temporal span of biodiversity monitoring mediates the effects of area and environment. \textit{\textbf{bioRxiv}}. [\href{https://doi.org/10.64898/2026.02.09.704769}{doi}]

\item Kadlec I., Uličný A., Keil P., \& \underline{Grattarola F.} (2025) Towards a new global database of regional red lists (RegRed): metadata. \textit{\textbf{ALPHA Preprints}}. [\href{https://doi.org/10.3897/arphapreprints.e160483}{doi}]
...
\begin{entrylist}
	\entry
		{2022 -- 2025\\\footnotesize{four editions}}
		{Spatial Ecology and Macroecology}
		{Faculty of Environmental Sciences, CZU (Czech Republic)}
		{Practical classes in the posgraduate course for 10 students. Taught together with François Leroy and led by Dr. Petr Keil [\href{https://github.com/petrkeil/Spatial-Ecology-and-Macroecology}{syllabus}]}
	\entry
		{2024 -- 2025\\\footnotesize{two editions}}
		{Open Science and Free Culture in Uruguay}
		{Facultad de Ciencias Sociales, UdelaR (Uruguay)}
		{Lecture in the course "Science, technology and society: what for and with whom do we do research?" for 30 students. Taught together with Gabriel Laufer and Lucía Rodríguez-Tricot [\href{https://flograttarola.com/talk/ciencia-abierta-y-cultura-libre-en-uruguay/Biodiversidata_FCS_abril_2025.pdf}{slides}]}
	\entry
...
\begin{minipage}[t]{0.35\textwidth}
	...
	\textbf{\href{https://scholar.google.com/citations?user=9KCM81IAAAAJ&hl}{Google Scholar}} (05/2026)\\
	803 citations, h-index = 12\\
\end{minipage} 
\hfill
...
\begin{entrylist}
	\entrylong
		{2026}
		{Temporal change and drivers of multiple facets of biodiversity at mesoscales}
		{Aarhus, Denmark}
		{\underline{Grattarola F.}*, Ortega-Solís G., Leroy F., Soria C., Tschernosterová K., Wölke F., Bejcek V., Fox R., Hart J.A., Herrando S., Hordley L., Keller V., Mikulas I., Monks A., Stastny K., Vorisek P., Ueta M., Walker S., Keil P. \slashsep Biennial Conference of the International Biogeography Society}
	\entrylong
		{2025}
		{RegRed: an effort to collate data on species' red list assessments at the national level}
		{Bogota, Colombia}
		{\underline{Grattarola F.}*, Uličný A., Kadlec I., Keil P. \slashsep Living Data 2025 [\href{https://flograttarola.com/talk/regred-an-effort-to-collate-data-on-species-red-list-assessments-at-the-national-level/6798638-1_7020809_Grattarola_Oral.pdf}{slides}]}
	\entrylong
		{2025\\\footnotesize{Invited}}
		{Ciencia ciudadana como estrategia de ciencia abierta y participativa}
		{Online}
		{\underline{Grattarola F.}* \slashsep Congreso Nacional de Biociencias de Uruguay [\href{https://flograttarola.com/talk/ciencia-ciudadana-como-estrategia-de-ciencia-abierta-y-participativa/charla_CNB_2025.pdf}{slides}]}
	\entrylong
		{2024}
		{Creación de reportes de proyectos de iNaturalist usando quarto}
		{Online}
		{\underline{Grattarola F.}* \slashsep LatinR 2024 [\href{https://bienflorencia.github.io/LatinR2024/slides/Grattarola_LatinR2024_slides.htm}{slides}]}
	\entrylong
		{2024}
		{The scale-dependency of species associations in the eyes of integrated SDMs}
		{Swansea, UK}
...
\begin{entrylist}
	\entrylong
		{2026}
		{Temporal change and drivers of multiple facets of biodiversity at intermediate scales}
		{}
		{Presentation at the seminar of the Department of Zoology, Palacký University Olomouc}
	\entrylong
		{2025}
		{NaturalistaUY: Un caso de ciencia comunitaria en América Latina desde una perspectiva crítica}
		{}
		{Presentation at the course Monitoreo Ambiental Participativo from Universidad de la República [\href{https://flograttarola.com/talk/naturalistauy-un-caso-de-ciencia-comunitaria-en-america-latina-desde-una-perspectiva-critica/EP_Monitoreo_Ambiental_Participativo_2025.pdf}{slides}]}
	\entrylong
		{2025}
		{Macroecology and the temporal dynamic of biodiversity at the global level}
		{}
		{Presentation at the monthly seminar series organised by the Regional Student Group Uruguay of the International Society of Computational Biology [\href{https://flograttarola.com/talk/macroecologia-y-la-dinamica-temporal-de-la-biodiversidad-a-nivel-global/ISCB-RSG_Uruguay.pdf}{slides}]}
	\entrylong
		{2025}
		{Using iNaturalist data in conservation}
		{}
		{Presentation to Uruguayan researchers updating the list of Priority Species of Uruguay (invited by the Ministery of Environment), on the use of data from iNaturalist [\href{https://flograttarola.com/talk/uso-de-datos-de-naturalistauy/CURE_SNAP_2025.pdf}{slides}]}
	\entrylong
		{2025}
		{Using iNaturalist data in research}
		{}
		{Presentation at the 2do Foro virtual mujeres naturalistas de México y Latinoamérica [\href{https://flograttarola.com/talk/uso-de-datos-de-inaturalist-en-la-investigacion/Foro_Mujeres_Naturalistas.pdf}{slides}]}
	\entrylong
		{2024}
