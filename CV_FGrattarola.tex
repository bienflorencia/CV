...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Send}{12}{\href{https://t.me/bienflorencia}{@bienflorencia}}\\
\end{minipage}
...
\item[]{\bf Rodrigo Montiel}, BSc (Honours) in Biological Sciences, School of Science, {\bf Universidad de la Rep\'{u}blica}. Project: 'NaturalistaUY as a community science tool to improve biodiversity knowledge in Uruguay'. Advisor, ongoing.  [\href{https://github.com/RodrigoMontiel/TesisNaturalistaUY}{github repo}]
\end{description}
